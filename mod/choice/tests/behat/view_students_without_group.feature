@mod @mod_choice
Feature: Viewing Choice results for students, who are not members of any group
  As a teacher
  I should be able to see Choice results for all visible groups, including students, who are not members of any group.
