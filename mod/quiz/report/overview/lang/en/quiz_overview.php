...
$string['regradealldrydoparticipantsnotingroup'] = 'Regrade attempts ({$a->countregradeneeded}) marked as needing regrading for participants not in a group';
$string['regradealldrygroup'] = 'Dry run a full regrade for group \'{$a->groupname}\'';
$string['regradealldryparticipantsnotingroup'] = 'Dry run a full regrade for participants not in a group';
$string['regradeallgroup'] = 'Full regrade for group \'{$a->groupname}\'';
$string['regradeallparticipantsnotingroup'] = 'Full regrade for participants not in a group';
