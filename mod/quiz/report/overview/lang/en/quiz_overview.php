...
$string['overviewreportgraphnotgroupmembers'] = 'Number of students who are not members of any group achieving grade ranges';
...
$string['regradealldrydonotgroupmembers'] = 'Regrade attempts ({$a->countregradeneeded}) marked as needing regrading for not members of any group';
$string['regradealldrygroup'] = 'Dry run a full regrade for group \'{$a->groupname}\'';
$string['regradealldrynotgroupmembers'] = 'Dry run a full regrade for not members of any group';
$string['regradeallgroup'] = 'Full regrade for group \'{$a->groupname}\'';
$string['regradeallnotgroupmembers'] = 'Full regrade for not members of any group';
