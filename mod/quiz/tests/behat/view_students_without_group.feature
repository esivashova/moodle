@mod @mod_quiz
Feature: Viewing Quiz results of students, who are not members of any group
  As a teacher
  I should be able to see Quiz results for all visible groups, including students, who are not members of any group
  ...
  Scenario: View quiz results
    ...
    And I set the field "Visible groups" to "Not a members of any group"
    And I should see "Attempts: 2 (1 from this group)"
    And "input[value='Full regrade for not members of any group']" "css_element" should exist
    And "input[value='Dry run a full regrade for not members of any group']" "css_element" should exist
    And I should see "Test User4"
    And I should not see "Test User2"
    And I should not see "Test User3"
    And I should not see "Test User1"
    And I should see "Number of students who are not members of any group achieving grade ranges"
    ...
    And I should see "1" in the "//*[@id='questionstograde']/tbody/tr[1]/td[7]" "xpath_element"
    And I should see "1" in the "//*[@id='questionstograde']/tbody/tr[2]/td[7]" "xpath_element"
    And I log out
