@mod @mod_assign
Feature: Viewing grades and submissions in Assignment for students, who are not members of any group
  As a teacher
  I should be able to see 'grading summary' and 'all submission' in Assignment activity for all visible groups, including students, who are not members of any group.
  ...
  Scenario: Students submit separately
    ...
    And "//tr[contains(., 'user1')]" "xpath_element" should exist
    And "//tr[contains(., 'user2')]" "xpath_element" should exist
    And "//tr[contains(., 'user3')]" "xpath_element" should exist
    And "//tr[contains(., 'user4')]" "xpath_element" should exist
    And I set the field "Visible groups" to "Not a members of any group"
    And "//tr[contains(., 'user4')]" "xpath_element" should exist
