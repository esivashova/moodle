@mod @mod_survey
Feature: Viewing Survey responses of students, who are not members of any group
  As a teacher
  I should be able to see Survey responses for all visible groups, including students, who are not members of any group
  ...
  Scenario: View survey responses
    ...
    And I follow "Course 1"
    And I follow "survey1"
    And I click on "View 2 survey responses" "link"
