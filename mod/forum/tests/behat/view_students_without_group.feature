@mod @mod_forum
Feature: Viewing Forum posts for students, who are not members of any group
  As a teacher
  I should be able to see that students, who are not members of any group, can only view posts for all participants
  ...
  Scenario: View forum posts
    ...
    And I follow "Course 1"
    And I follow "forum1"
    And I should see "Not a members of any group"
    And I press "Add a new discussion topic"
    And I set the following fields to these values:
      | Subject  | topic3 |
      | Message | message for not a members of any group |
    And I press "Post to forum"
    And I should see "topic1"
    And I should not see "topic2"
    ...
    And I should see "topic1"
    And I should see "topic2"
    And I should not see "topic3"
    And I set the field "Separate groups" to "Not a members of any group"
    And I should see "topic1"
    And I should not see "topic2"
    And I should see "topic3"
    And I log out
