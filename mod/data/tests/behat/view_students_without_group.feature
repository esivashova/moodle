@mod @mod_data
Feature: Viewing entries of Data activity for students, who are not members of any group
  As a teacher
  I should be able to see Database entries for all visible groups, including students, who are not members of any group
  ...
  Scenario: View entries for different groups
    ...
    And I add a "Text input" field to "database1" database and I fill the form with:
      | Field name | f1 |
