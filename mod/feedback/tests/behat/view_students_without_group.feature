@mod @mod_feedback
Feature: Viewing Feedback responds of students, who are not members of any group.
  As a teacher
  I should be able to see Feedback responds for all visible groups, including students, who are not members of any group
